...
# 📖 [Portofolio set up mobile first] <a name="about-project"></a>

> 

**[Portofolio set up mobile first]** is a project that set up the mobile version of a protofolio that display your background of knpwlodges to recruters.
...
```sh
  cd my-folder
  git clone https://github.com/Kaghenimbale/Microverse-Portofolio.git
```
--->
